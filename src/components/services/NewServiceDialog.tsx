        ...
        >
          <div className="flex-1 overflow-y-auto w-full p-8 space-y-6">
            ...
            <div className="space-y-2">
              <Label htmlFor="name" className="text-xs font-black uppercase tracking-widest text-gray-400 dark:text-gray-500">{t('form.name')}</Label>
              <Input 
                id="name"
                name="name"
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="space-y-2">
                <Label htmlFor="price" className="text-xs font-black uppercase tracking-widest text-gray-400 dark:text-gray-500">{t('form.price')}</Label>
                <div className="relative">
              ...
              <div className="space-y-2">
                <Label htmlFor="duration" className="text-xs font-black uppercase tracking-widest text-gray-400 dark:text-gray-500">{t('form.duration')}</Label>
                <div className="relative">
            ...
            {/* Description */}
            <div className="space-y-2">
              <Label htmlFor="description" className="text-xs font-black uppercase tracking-widest text-gray-400 dark:text-gray-500">{t('form.description')}</Label>
              <Textarea 
                id="description"
                name="description"
